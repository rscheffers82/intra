                            ...
                            if (is_user_logged_in()) :
                                if ($header_user == "yep") : ?>
                                    <div id="nav-user" class="clearfix <?php echo (function_exists('bp_is_active')) ? 'bp_is_active' : ''; ?>">
                                            ...
                                            <?php
                                            $name_to_display = get_userdata(get_current_user_id())->display_name;

                                            printf( _x( 'Hi <strong>%s</strong>!', "Hi USERNAME - It's the welcome message in the header", 'woffice' ), $name_to_display );
                                            ?>
